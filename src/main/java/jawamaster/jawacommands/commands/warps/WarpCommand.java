...
public class WarpCommand implements CommandExecutor {
    ...
    public final String USAGE = ChatColor.GREEN + "> /warp <warp> [other]. Run without any arguments to list the warps you have access to.";
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String label, String[] args) {
        ...
        } else if (args.length >= 1 && commandSender.hasPermission(OTHERPERMISSION)) {
